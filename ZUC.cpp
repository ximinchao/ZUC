...
/*u32 EK_d[16] = { 
0xD744, 0xBC26, 0x6B62, 0x5E13, 0x8957, 0xE235, 0x3571, 0xAF09, 
0x784D, 0x132F, 0xC46B, 0xF11A, 0x265E, 0x4D3C, 0x9A78, 0xAC47 
};*/
...
#define MAKEU32(a, b, c, d) (((u32)((u32)(0) | (u8)(a)) << 24) | ((u32)((u32)(0) | (u8)(b)) << 16) | ((u32)((u32)(0) | (u8)(c)) << 8) | ((u32)((u32)(0) | (u8)(d))))
/*F*/
u32 F()
{
	u32 W, W1, W2, u, v;
